...
The output from `mkref` should be named `GRCh38_index`.
...
* **--create-bam <true/false>** - indicate whether or not we want a BAM alignment file to be saved. Unless you have a reason to keep the BAM files, it's often not worth the extra disk space they take up, so you can set this to `false` in your analysis. We'll set it to `true` for demonstration purposes. 
...
we just generated.
  * **Note**: If you didn't complete the previous exercise, you can use a pre-processed 
genome index provided in `Data/references/cellranger_index`.
...
<div style="text-align: center;">
  <img src="Images/CellRangerOutput.png" alt="Cell Ranger Output Directory" style="width:50%;">
</div>

The contents of the `outs` directory are:

<div style="text-align: center;">
  <img src="Images/CellRangerOutputOuts.png" alt="Cell Ranger Output Directory - outs" style="width:50%;">
</div>
...
<div style="text-align: center;">
  <img src="Images/LoupeBrowser.png" alt="Loupe Browser Screenshot" style="width:75%;">
</div>
