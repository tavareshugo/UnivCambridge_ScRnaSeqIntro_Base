...
```
From these two plots we can see that clusters 2, 5 and 8 appear to have a good
degree of separation. In contrast, clusters 1, 2 and 4 have a large number of
cells that appear to be closer to cluster 3. It is possible clusters 1-4 contain
