...
<div style="width: 75%; float: top; padding-left: 10%; padding-top: 10%">
<img src="Images/sce_object_counts_matrix.png" class="centerimg" style="width: 75%">
</div>

<div style="width: 80%; float: left;">
 To access counts from sce object: __counts(sce)__
</div>
...
<div style="width: 75%; float: top; padding-left: 10%; padding-top: 10%">
<img src="Images/sce_object_feature_metadata.png" class="centerimg" style="width: 75%">
</div>

<div style="width: 80%; float: left;">
 To access gene metadata from sce object: __rowData(sce)__
</div>
...
<div style="width: 75%; float: top; padding-left: 10%; padding-top: 10%">
<img src="Images/sce_object_cell_metadata.png" class="centerimg" style="width: 75%">
</div>

<div style="width: 80%; float: left;">
 To access cell metadata from sce object: __colData(sce)__
</div>
